...
public partial class CharacterToolBar : UserControl
{
    ...
    public CharacterToolBar() : this(null!)
    {
    }

    public CharacterToolBar(IMainWindow mainWindow)
    {
    ...
    private void CreateGreekCapitalPanel()
    {
        string[] items = [
            "\u0391", "\u0392", "\u0393", "\u0394", "\u0395", "\u0396", "\u0397",
            "\u0398", "\u0399", "\u039A", "\u039B", "\u039C", "\u039D", "\u039E",
    ...
    private void CreateGreekSmallPanel()
    {
        string[] items = [
            "\u03B1", "\u03B2", "\u03B3", "\u03B4", "\u03B5", "\u03B6", "\u03B7",
            "\u03B8", "\u03B9", "\u03BA", "\u03BB", "\u03BC", "\u03BD", "\u03BE",
    ...
    private void CreateArrowsPanel()
    {
        string[] items = [
            "\u2190", "\u2191", "\u2192", "\u2193", "\u2194", "\u2195", "\u2196",
            "\u2197", "\u2198", "\u2199", "\u219A", "\u219B", "\u219C", "\u219D",
